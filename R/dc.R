...
#'
#' @export
dc <- function(data, chartRecipe = c("qqqyearlyBubbleChart", "gainOrLossChart",　"quarterChart",　"dayOfWeekChart",　"fluctuationChart",　"moveChart",　"dataCount",　"dataTable"), title = NULL,
